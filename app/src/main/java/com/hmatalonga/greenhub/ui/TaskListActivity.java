...
import com.hmatalonga.greenhub.response.AppListData;
...
//    }
    ...
    private void loadComponents() {
        ...
        AppResponse appResponse = (AppResponse) getIntent().getSerializableExtra("list");

        TextView dateTime = findViewById(R.id.dateTime);
        TextView batteryLevel = findViewById(R.id.batteryLevel);
        TextView freeMemory = findViewById(R.id.freeMemory);
        TextView totalKilledApp = findViewById(R.id.totalKilledApp);
        TextView bluetooth = findViewById(R.id.bluetooth);
        TextView torch = findViewById(R.id.torch);
        TextView data = findViewById(R.id.data);

        dateTime.setText(appResponse.getDate());
        batteryLevel.setText(appResponse.getLevel());
        freeMemory.setText(appResponse.getMemory());
        totalKilledApp.setText(appResponse.getApps());
        bluetooth.setText(appResponse.getBluetooth());
        torch.setText(appResponse.getTourch());

        Log.i("====> ", "loadComponents:  " + appResponse.getLevel());
...
//
//                    String mUid = actor.getString("mUid");
//                    String mName = actor.getString("mName");
//                    Task task = new Task(Integer.parseInt(mUid), mName);
//                    mTaskList.add(task);
//                }
//
//
